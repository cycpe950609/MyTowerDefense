...
void LoseScene::Initialize() {
	...
	btn->SetOnClickCallback(std::bind(&LoseScene::RestartOnClick, this, 2));
	AddNewControlObject(btn);
	AddNewObject(new Engine::Label("Restart", "pirulen.ttf", 48, halfW, halfH * 3 / 2 + 125, 0, 0, 0, 255, 0.5, 0.5));
...
void LoseScene::RestartOnClick(int stage)
{
